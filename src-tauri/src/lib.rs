...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ipc::eventlog_count,
            ipc::eventlog_export_html,
            ipc::eventlog_export_pdf,
            ipc::eventlog_export_xlsx,
            ...
            ipc::ai_get_settings,
            ipc::ai_list_providers,
            ipc::ai_add_provider,
            ipc::ai_update_provider,
            ipc::ai_delete_provider,
            ipc::ai_set_active_provider,
            ipc::ai_set_provider,
